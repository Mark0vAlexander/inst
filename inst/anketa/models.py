...
class vopros(models.Model):
        id = models.CharField(max_length=20, verbose_name='Индификационный номер')
        desr = models.TextField(blank=True, verbose_name='Вопрос')
        kompet_id = models.CharField(max_length=20, verbose_name='Индификационный номер компетенции')
        score = models.IntegerField(verbose_name='Максимум баллов')

class test(models.Model):
        id = models.CharField(max_length=20, verbose_name='Индификационный номер')
        kompet_id = models.CharField(max_length=20, verbose_name='Индификационный номер компетенции')
        vopros_id = models.CharField(max_length=20, verbose_name='Индификационный номер вопроса')
